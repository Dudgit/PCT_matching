...
The base structure of the model can be seen in ![Figure 1](/_includes/Base_architecture.png)  , which is already achiving 67% percent accuracy in the matching. To improve it I already added some extra layers for the embedding. I'm experimenting all the time, but one of the best improvements can be seen in ![Figure 2.](/_includes/Alternate_version.png)
